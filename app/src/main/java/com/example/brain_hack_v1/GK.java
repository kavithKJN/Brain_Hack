...
public class GK extends AppCompatActivity {
    ...
    private QuestionsGK mQuestions = new QuestionsGK();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(GK.this, QuestionSelect.class));
...
//////////////////////////////////////////////////////////////////////
    ...
    public void checkBtn(View v) {
        ...
        if (Answer1.getText() == mAnswer) {
            ...
            Ques_number.setText(k + "/10");
            if (k==10){
                startActivity(new Intent(GK.this,LastActivity2.class));
                BackGroundSound.pause();
                finish();
            }
